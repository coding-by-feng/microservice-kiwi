...
/**
 * Paraphrase Star Relation Entity - junction table for paraphrase star list and paraphrases
 *
 * @author codingByFeng
 */
@Data
...
public class ParaphraseStarRel extends Model<ParaphraseStarRel> {
    ...
    @JsonIgnore
    public boolean isKeptInMind() {
        return this.isKeepInMind != null && this.isKeepInMind == 1;
    }
    ...
    public void markKeptInMind() {
        this.isKeepInMind = 1;
        this.keepInMindTime = LocalDateTime.now();
    }
