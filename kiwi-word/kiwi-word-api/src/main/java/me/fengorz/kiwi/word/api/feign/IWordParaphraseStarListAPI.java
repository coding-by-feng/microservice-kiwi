 ...
 */
@FeignClient(contextId = "remoteWordParaphraseStarListDOService" , value = WordConstants.KIWI_WORD_BIZ, fallbackFactory = WordParaphraseStarListServiceFallbackFactory.class)
