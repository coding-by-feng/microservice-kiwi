...
import me.fengorz.kason.common.es.config.ESConfig;
import me.fengorz.kason.common.tts.config.TtsConfig;
...
@Slf4j
@Configuration
@ComponentScan("me.fengorz.kason.word.**")
@Import({CoreConfig.class, DbConfig.class, CacheConfig.class, DfsConfig.class, ESConfig.class, TtsConfig.class})
