...
public class EnablerAspectConfig {
    ...
    @Pointcut("@annotation(me.fengorz.kason.common.mq.MqAwake) && within(me.fengorz.kason.dict.crawler..*)")
    public void mqPointcut() {
    }

    @Pointcut("@annotation(me.fengorz.kason.common.sdk.annotation.ScheduledAwake) && within(me.fengorz.kason.dict.crawler..*)")
