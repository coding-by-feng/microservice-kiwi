...
import me.fengorz.kason.bdf.security.google.GoogleRemoteTokenServices;
...
public class KasonResourceServerConfigurerAdapter extends ResourceServerConfigurerAdapter {
    ...
    private GoogleRemoteTokenServices createEnhancedTokenServices() {
        ...
        enhancedServices.setCheckTokenEndpointUrl("http://kason-auth:3001/oauth/check_token");
        enhancedServices.setClientId("kason-resource-server");
        enhancedServices.setClientSecret("kason-resource-server-secret");
        enhancedServices.setRestTemplate(lbRestTemplate);

        // Configure token converter
        DefaultAccessTokenConverter accessTokenConverter = new DefaultAccessTokenConverter();
        KasonUserAuthenticationConverter userTokenConverter =
                new KasonUserAuthenticationConverter(filterIgnorePropertiesConfig);
