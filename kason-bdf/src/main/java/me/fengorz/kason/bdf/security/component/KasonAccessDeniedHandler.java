...
import me.fengorz.kason.bdf.security.exception.KasonDeniedException;
...
public class KasonAccessDeniedHandler extends OAuth2AccessDeniedHandler {
    ...
    public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException authException)
        ...
        R<KasonDeniedException> result = R.failed(new KasonDeniedException("授权失败，禁止访问"));
