...
public interface IJsoupService {
    ...
    FetchWordResultDTO fetchWordInfo(WordMessageDTO wordMessage) throws JsoupFetchConnectException, JsoupFetchResultException, JsoupFetchPronunciationException;
