...
# Kason IP Change Daemon (Single-Pi)
...
SETUP_BASE_DIR="${KASON_SETUP_BASE_DIR:-"$SCRIPT_HOME"}"
...
PID_FILE="/var/run/kason-ip-change-daemon.pid"
LOCK_FILE="/var/run/kason-ip-change-daemon.lock"
