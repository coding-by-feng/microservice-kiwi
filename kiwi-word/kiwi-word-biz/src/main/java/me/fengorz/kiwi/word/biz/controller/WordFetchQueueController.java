...
public class WordFetchQueueController extends BaseController {
    ...
    public R<IPage<WordFetchQueueDO>>
        getWordFetchQueuePage(@RequestBody @Valid WordFetchQueuePageDTO wordFetchQueuePage) {
        return R.success(wordFetchQueueService.page(wordFetchQueuePage.getPage(),
            Wrappers.query(wordFetchQueuePage.getWordFetchQueue())));
    }
