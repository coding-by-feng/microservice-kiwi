...
import me.fengorz.kason.word.api.entity.ExampleStarListDO;
import me.fengorz.kason.word.api.entity.ExampleStarRelDO;
import me.fengorz.kason.word.api.entity.column.WordParaphraseExampleListColumn;
import me.fengorz.kason.word.api.vo.ExampleStarListVO;
import me.fengorz.kason.word.api.vo.star.ExampleStarItemVO;
import me.fengorz.kason.word.biz.mapper.ExampleStarListMapper;
import me.fengorz.kason.word.biz.service.base.ExampleStarListService;
import me.fengorz.kason.word.biz.service.base.ExampleStarRelService;
...
public class ExampleStarListServiceImpl extends ServiceImpl<ExampleStarListMapper, ExampleStarListDO>
    ...
    public List<ExampleStarListVO> getCurrentUserList(Integer userId) {
        ...
        return KasonBeanUtils.convertFrom(mapper.selectList(queryWrapper), ExampleStarListVO.class);
    }
    ...
    public void removeOneRel(Integer exampleId, Integer listId) {
        ...
        KasonAssertUtils.assertNotEmpty(count, "example is not exists!");
