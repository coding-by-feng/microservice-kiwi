...
package me.fengorz.kiwi.common.cache.redis;

import lombok.NoArgsConstructor;
import me.fengorz.kiwi.common.api.annotation.KiwiCacheKey;
import me.fengorz.kiwi.common.api.annotation.KiwiCacheKeyPrefix;
import me.fengorz.kiwi.common.api.constant.CommonConstants;
import me.fengorz.kiwi.common.sdk.lang.array.KiwiArrayUtils;
import me.fengorz.kiwi.common.sdk.lang.object.KiwiObjectUtils;
import me.fengorz.kiwi.common.sdk.lang.string.KiwiStringUtils;
...
public class CacheKeyGenerator extends SimpleKeyGenerator {
    ...
    public Object generate(Object target, Method method, Object... params) {
        ...
        prefix = kiwiCacheKeyPrefix == null ? CommonConstants.EMPTY : kiwiCacheKeyPrefix.value();
        ...
        if (KiwiArrayUtils.isNotEmpty(parameters)) {
            ...
            if (!sortedMap.isEmpty()) {
                return prefix.concat(KiwiStringUtils.join(CommonConstants.COMMA, sortedMap.values()));
            }
        }
