...
/**
 * YouTube Video Subtitles Entity
 *
 * @author codingByFeng
 */
@Data
...
public class YtbVideoSubtitles extends Model<YtbVideoSubtitles> {

    private static final long serialVersionUID = 1L;

    public static final Integer TYPE_PROFESSIONAL = 1;
    public static final Integer TYPE_AUTO_GENERATED = 2;
