 ...
 */
public interface WordParaphraseMapper extends BaseMapper<WordParaphraseDO> {

    List<WordParaphraseVO> selectParaphraseAndIsCollect(@Param(MapperConstant.QUERY_PARAMS) SelectEntityIsCollectDTO dto);
