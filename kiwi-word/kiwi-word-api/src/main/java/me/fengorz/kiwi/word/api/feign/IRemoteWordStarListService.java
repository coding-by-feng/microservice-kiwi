 ...
 */
@FeignClient(contextId = "remoteWordStarListDOService", value = WordCrawlerConstants.VOCABULARY_ENHANCER_CRAWLER_BIZ, fallbackFactory = RemoteWordStarListServiceFallbackFactory.class)
