 ...
 */
public interface WordParaphraseExampleMapper extends BaseMapper<WordParaphraseExampleDO> {

    List<WordParaphraseExampleVO> selectExampleAndIsCollect(@Param(MapperConstant.QUERY_PARAMS) SelectEntityIsCollectDTO dto);
