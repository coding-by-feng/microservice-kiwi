...
import me.fengorz.kason.word.api.dto.mapper.in.CountEntityIsCollectDTO;
import me.fengorz.kason.word.api.dto.mapper.out.SelectWordStarListResultDTO;
import me.fengorz.kason.word.api.entity.WordStarListDO;
import me.fengorz.kason.word.api.entity.WordStarRelDO;
import me.fengorz.kason.word.api.entity.column.WordStarListColumn;
import me.fengorz.kason.word.api.vo.WordStarListVO;
import me.fengorz.kason.word.api.vo.star.WordStarItemParaphraseVO;
import me.fengorz.kason.word.api.vo.star.WordStarItemVO;
import me.fengorz.kason.word.biz.mapper.WordStarListMapper;
import me.fengorz.kason.word.biz.service.base.WordStarListService;
import me.fengorz.kason.word.biz.service.base.WordStarRelService;
import me.fengorz.kason.word.biz.service.operate.AsyncArchiveService;
...
public class WordStarListServiceImpl extends ServiceImpl<WordStarListMapper, WordStarListDO>
    ...
    public List<WordStarListVO> getCurrentUserList(Integer userId) {
        ...
        return KasonBeanUtils.convertFrom(wordStarListMapper.selectList(queryWrapper), WordStarListVO.class);
    }
    ...
    public void removeStarList(Integer wordId, Integer listId) {
        LambdaQueryWrapper<WordStarRelDO> queryWrapper = new LambdaQueryWrapper<WordStarRelDO>()
            .eq(WordStarRelDO::getListId, listId).eq(WordStarRelDO::getWordId, wordId);
        KasonAssertUtils.assertNotEmpty(relService.count(queryWrapper), "wordStar is not exists!");
