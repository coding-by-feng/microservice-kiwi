...
/**
 * Star Relation History - tracks archive history for starred items
 *
 * @author codingByFeng
 */
@Data
...
public class StarRelHis extends Model<StarRelHis> {

    private static final long serialVersionUID = 1L;

    public static final int TYPE_WORD = 1;
    public static final int TYPE_PARAPHRASE = 2;
