...
package me.fengorz.kason.common.cache.redis.config;

import lombok.extern.slf4j.Slf4j;
import me.fengorz.kason.common.cache.redis.CacheKeyGenerator;
...
@Slf4j
@Configuration
@ComponentScan("me.fengorz.kason.common.cache.**")
@EnableCaching(mode = AdviceMode.ASPECTJ)
@AutoConfigureBefore(RedisAutoConfiguration.class)
@ConditionalOnProperty(value = "ms.config.exclude-cache", havingValue = "false")
public class CacheIncludeConfig {

    private final RedisConnectionFactory factory;

    public CacheIncludeConfig(RedisConnectionFactory factory) {
        log.info("CacheIncludeConfig...");
