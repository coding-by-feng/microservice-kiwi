...
package me.fengorz.kason.crawler.util;
...
public class CrawlerUtils {
    ...
    public static boolean is2word(FetchPhraseResultDTO resultDTO) {
        return KasonCollectionUtils.isEmpty(resultDTO.getRelatedWords())
            && KasonCollectionUtils.isEmpty(resultDTO.getFetchParaphraseDTOList());
    }
}
