...
package me.fengorz.kason.generator;
...
import me.fengorz.kason.common.sdk.util.time.KasonDateFormatUtils;
import me.fengorz.kason.common.sdk.util.time.KasonDateUtils;
import me.fengorz.kason.generator.common.ToolConstants;
import me.fengorz.kason.generator.entity.ColumnEntity;
import me.fengorz.kason.generator.entity.GenerateAbility;
import me.fengorz.kason.generator.entity.GenerateConfig;
import me.fengorz.kason.generator.entity.TableEntity;
import me.fengorz.kason.generator.util.ToolBeanUtils;
import me.fengorz.kason.generator.util.ToolIOUtils;
...
public class CustomCodeGenerator {
    ...
    public static void generatorCode(GenerateAbility generateAbility, GenerateConfig generateConfig,
        ...
        map.put("datetime", KasonDateFormatUtils.format(new Date(), KasonDateUtils.DEFAULT_TIME_PATTERN));
