...
public class AsyncFetchPronunciationProducer implements IProducer {
    ...
    public void produce() {
        WordFetchQueueDO wordFetchQueue =
            new WordFetchQueueDO().setFetchStatus(WordCrawlerConstants.STATUS_TO_FETCH_PRONUNCIATION)
