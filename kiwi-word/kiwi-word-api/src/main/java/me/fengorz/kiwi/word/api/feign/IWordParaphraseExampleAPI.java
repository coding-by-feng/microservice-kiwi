 ...
 */
@FeignClient(contextId = "remoteWordParaphraseExampleService" , value = WordConstants.KIWI_WORD_BIZ, fallbackFactory = WordParaphraseExampleServiceFallbackFactory.class)
