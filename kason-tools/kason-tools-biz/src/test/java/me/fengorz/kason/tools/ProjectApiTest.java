...
public class ProjectApiTest {
    ...
    public void testCreateAndList() throws Exception {
        ...
        mockMvc.perform(post("/api/projects")
                        ...
                        .accept(JSON_UTF8)
                        .content(KasonJsonUtils.toJsonPretty(body)))
                .andDo(print())
    ...
    public void e2e_create100_list_then_delete50_and_verify_totals() throws Exception {
        ...
        MvcResult page1 = mockMvc.perform(get("/api/projects")
                ...
                .andExpect(status().isOk())
                .andReturn();
        java.util.Map<?, ?> body = KasonJsonUtils.fromJson(page1.getResponse().getContentAsString(), java.util.Map.class);
    ...
    public void e2e_validation_and_patch_update() throws Exception {
        ...
        mockMvc.perform(post("/api/projects")
                        ...
                        .content(KasonJsonUtils.toJsonPretty(bad)))
        ...
        patchBody.put("clientName", "Kason Ltd");
        ...
        MvcResult patchedRes = mockMvc.perform(patch("/api/projects/{id}", p.getId())
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.clientName", is("Kason Ltd")))
                .andExpect(jsonPath("$.archived", is(true)))
                .andReturn();

        Project patched = KasonJsonUtils.fromJson(patchedRes.getResponse().getContentAsString(), Project.class);
    ...
    private Project createProject(String name, String status) throws Exception {
        ...
        return KasonJsonUtils.fromJson(res.getResponse().getContentAsString(), Project.class);
    }
    ...
    private long getTotal(boolean includeArchived, String q) throws Exception {
        ...
        MvcResult res = mockMvc.perform(req)
                .andExpect(status().isOk())
                .andReturn();
        java.util.Map<?, ?> body = KasonJsonUtils.fromJson(res.getResponse().getContentAsString(), java.util.Map.class);
