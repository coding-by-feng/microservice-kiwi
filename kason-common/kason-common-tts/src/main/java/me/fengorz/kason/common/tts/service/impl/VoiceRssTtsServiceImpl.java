...
package me.fengorz.kason.common.tts.service.impl;
...
import me.fengorz.kason.common.tts.TtsConstants;
import me.fengorz.kason.common.tts.enumeration.TtsSourceEnum;
import me.fengorz.kason.common.tts.model.TtsProperties;
...
public class VoiceRssTtsServiceImpl implements TtsService {
    ...
    @KasonCacheKeyPrefix(TtsConstants.CACHE_KEY_PREFIX_TTS.TTS_VOICE_RSS_API_KEY_USED_TIME)
    @Cacheable(cacheNames = TtsConstants.CACHE_NAMES, keyGenerator = CacheConstants.CACHE_KEY_GENERATOR_BEAN,
            unless = "#result == null")
    @Override
    public Integer queryTtsApiKeyUsed(@KasonCacheKey String apiKey) {
        return null;
    }
    ...
    @CachePut(cacheNames = TtsConstants.CACHE_NAMES, keyGenerator = CacheConstants.CACHE_KEY_GENERATOR_BEAN,
            unless = "#result == null")
    @Override
    public int useTtsApiKey(@KasonCacheKey String apiKey, int time) {
        return time;
    }
    ...
    private byte[] wrap(byte[] bytes) {
        return KasonAssertUtils.assertNotEmpty(bytes, "%s TTS generated bytes must not be null.",
