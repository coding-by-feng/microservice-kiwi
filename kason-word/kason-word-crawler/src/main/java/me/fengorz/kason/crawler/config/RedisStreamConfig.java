...
import me.fengorz.kason.crawler.redismq.ListenerMessage;
...
public class RedisStreamConfig {
    ...
    public Subscription subscription(RedisConnectionFactory factory) {
        ...
        Subscription subscription = listenerContainer.receiveAutoAck(Consumer.from("kason", "test"),
            StreamOffset.create("kason", ReadOffset.lastConsumed()), streamListener);
