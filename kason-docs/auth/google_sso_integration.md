# Google SSO Integration Guide for Kason Auth & UPMS

## Overview

This guide provides a complete integration of Google Single Sign-On (SSO) with your existing Kason authentication system and UPMS module. The integration includes:
...
Add the Google OAuth2 dependencies to your `kason-auth/pom.xml`:
...
Update `bootstrap.yml` in kason-auth:
```yaml
google:
  oauth2:
