 ...
 */
public interface ReviewAudioService extends IService<WordReviewAudioDO> {

    void cleanAndInsert(WordReviewAudioDO entity);

    void cleanBySourceId(Integer sourceId);
