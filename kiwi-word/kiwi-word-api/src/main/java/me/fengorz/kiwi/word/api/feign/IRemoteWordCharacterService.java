 ...
 */
@FeignClient(contextId = "remoteWordCharacterService", value = CrawlerConstants.VOCABULARY_ENHANCER_CRAWLER_BIZ, fallbackFactory = RemoteWordCharacterServiceFallbackFactory.class)
