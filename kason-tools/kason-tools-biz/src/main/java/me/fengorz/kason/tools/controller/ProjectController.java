...
import me.fengorz.kason.tools.api.project.dto.ProjectPatchRequest;
import me.fengorz.kason.tools.exception.ToolsException;
import me.fengorz.kason.tools.mapper.ProjectDtoMapper;
import me.fengorz.kason.tools.model.project.Project;
import me.fengorz.kason.tools.model.project.ProjectPhoto;
import me.fengorz.kason.tools.service.ProjectPhotoService;
import me.fengorz.kason.tools.service.ProjectService;
import me.fengorz.kason.tools.service.StorageService;
...
public class ProjectController {
    ...
    public me.fengorz.kason.tools.api.project.dto.PageResponse<me.fengorz.kason.tools.api.project.dto.ProjectResponse> listProjects(
    ...
    public me.fengorz.kason.tools.api.project.dto.ProjectResponse getProject(@ApiParam(value = "Project id", required = true) @PathVariable String id) {
    ...
    public ResponseEntity<me.fengorz.kason.tools.api.project.dto.ProjectResponse> createProject(@ApiParam(value = "Project fields", required = true) @RequestBody me.fengorz.kason.tools.api.project.dto.ProjectCreateRequest body) {
    ...
    public me.fengorz.kason.tools.api.project.dto.ProjectResponse updateProject(@ApiParam(value = "Project id", required = true) @PathVariable String id,
                                                                               @ApiParam(value = "Partial fields to update") @RequestBody me.fengorz.kason.tools.api.project.dto.ProjectUpdateRequest body) {
    ...
    public me.fengorz.kason.tools.api.project.dto.ProjectResponse patchProject(@ApiParam(value = "Project id", required = true) @PathVariable String id,
    ...
    public me.fengorz.kason.tools.api.project.dto.ProjectResponse archiveProject(@ApiParam(value = "Project id", required = true) @PathVariable String id,
                                                                                @RequestParam(value = "archived", required = false) Boolean archived,
                                                                                @ApiParam(value = "Optional body {archived:true|false}") @RequestBody(required = false) me.fengorz.kason.tools.api.project.dto.ProjectArchiveRequest body) {
    ...
    public me.fengorz.kason.tools.api.project.dto.ProjectPhotoResponse uploadPhoto(@ApiParam(value = "Project id", required = true) @PathVariable("id") String projectId,
    ...
    public List<me.fengorz.kason.tools.api.project.dto.ProjectPhotoResponse> listPhotos(@ApiParam(value = "Project id", required = true) @PathVariable("id") String projectId) {
