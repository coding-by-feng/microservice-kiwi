...
/**
 * Legacy Project Controller - Public access without authentication
 * Mapped to /rangi_windows/api for backward compatibility
 *
 * @author codingByFeng
 */
@Slf4j
...
@Tag(name = "Projects (Legacy)", description = "Legacy CRUD and media management for Projects - No auth required")
public class ProjectLegacyController {
