...
public class DeepCopyTest {
    ...
    public void mapTest() {
        ...
        System.out.println(KasonJsonUtils.toJsonStr(originMap));

        model.setName("test2");
        System.out.println(KasonJsonUtils.toJsonStr(originMap));
        System.out.println(KasonJsonUtils.toJsonStr(updatedFromConstructorMap));
        System.out.println(KasonJsonUtils.toJsonStr(updatedFromSerializationMap));
    }
