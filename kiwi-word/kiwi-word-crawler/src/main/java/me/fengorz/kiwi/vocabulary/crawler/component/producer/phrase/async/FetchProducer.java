...
public class FetchProducer extends AbstractProducer implements IProducer {
    ...
    public FetchProducer(IWordBizAPI wordBizAPI, IPhraseBizAPI phraseBizAPI, ISender sender) {
        super(wordBizAPI, phraseBizAPI, sender, WordCrawlerConstants.QUEUE_INFO_TYPE_PHRASE);
    }
