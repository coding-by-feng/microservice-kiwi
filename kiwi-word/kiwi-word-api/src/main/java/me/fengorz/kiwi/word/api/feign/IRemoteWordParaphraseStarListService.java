 ...
 */
@FeignClient(contextId = "remoteWordParaphraseStarListDOService", value = CrawlerConstants.VOCABULARY_ENHANCER_CRAWLER_BIZ, fallbackFactory = RemoteWordParaphraseStarListServiceFallbackFactory.class)
