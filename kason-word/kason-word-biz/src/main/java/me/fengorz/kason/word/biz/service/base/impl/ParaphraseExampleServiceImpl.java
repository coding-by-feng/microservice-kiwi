...
import me.fengorz.kason.word.api.dto.mapper.in.SelectEntityIsCollectDTO;
import me.fengorz.kason.word.api.entity.ParaphraseExampleDO;
import me.fengorz.kason.word.api.vo.ParaphraseExampleVO;
import me.fengorz.kason.word.biz.mapper.ParaphraseExampleMapper;
import me.fengorz.kason.word.biz.service.base.ParaphraseExampleService;
...
public class ParaphraseExampleServiceImpl extends ServiceImpl<ParaphraseExampleMapper, ParaphraseExampleDO>
    ...
    public List<ParaphraseExampleVO> listExamples(Integer paraphraseId) {
        return KasonBeanUtils.convertFrom(mapper.selectList(
