...
-- 1. Default Kiwi client for traditional authentication
...
INSERT INTO oauth_client_details (
    ...
    autoapprove
             ...
             2592000, -- 30 days
             2592000, -- 30 days
             '{"description": "Google SSO client for Kiwi authentication"}',
             'true'
         );
...
-- GRANT SELECT, INSERT, UPDATE, DELETE ON kiwi_db.oauth_* TO 'oauth2_user'@'localhost';
-- GRANT SELECT ON kiwi_db.sys_user TO 'oauth2_user'@'localhost';
