...
package me.fengorz.kason.crawler.component.consumer.word;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import me.fengorz.kason.crawler.component.consumer.base.AbstractConsumer;
import me.fengorz.kason.crawler.component.consumer.base.IConsumer;
import me.fengorz.kason.crawler.config.properties.CrawlerConfigProperties;
import me.fengorz.kason.crawler.service.FetchService;
import me.fengorz.kason.word.api.dto.queue.FetchPronunciationMqDTO;
...
@RabbitListener(bindings = @QueueBinding(
    value = @Queue(value = "${mq.config.pronunciationFromCambridge.fetchQueue}", autoDelete = "true"),
