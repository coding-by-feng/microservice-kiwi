...
package me.fengorz.kiwi.vocabulary.crawler.util;
...
public class CrawlerAssertUtils {
    ...
    public static String fetchValueNotEmpty(String fetchValue, String errorMsgTemplate, Object... params)
    ...
    public static Collection notEmpty(Collection collection, String errorMsgTemplate, Object... params)
        throws JsoupFetchResultException {
