...
public class ProjectPhotoApiTest {
    ...
    public void upload_list_download_delete_photo() throws Exception {
        ...
        MvcResult created = mockMvc.perform(post("/api/projects")
                ...
                .andReturn();
        Map<?, ?> project = KiwiJsonUtils.fromJson(created.getResponse().getContentAsString(), Map.class);
        ...
        MvcResult uploaded = mockMvc.perform(multipart("/api/projects/{id}/photo", projectId)
                ...
                .andReturn();
        Map<?, ?> photo = KiwiJsonUtils.fromJson(uploaded.getResponse().getContentAsString(StandardCharsets.UTF_8), Map.class);
    ...
    public void reject_non_image_upload() throws Exception {
        ...
        String createJson = "{\n" +
                ...
                "  \"address\": \"Kiwi HQ\"\n" +
                "}";
        String projectId = KiwiJsonUtils.fromJson(
