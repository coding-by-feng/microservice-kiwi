 ...
 */
public interface IWordParaphraseExampleService extends IService<WordParaphraseExampleDO> {

    Integer countById(Integer id);

    List<WordParaphraseExampleVO> selectExampleAndIsCollect(Integer owner, Integer paraphraseId);
