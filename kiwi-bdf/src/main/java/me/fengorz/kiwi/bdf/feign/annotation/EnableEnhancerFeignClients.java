...
public @interface EnableEnhancerFeignClients {
    ...
    /**
     * A custom <code>@Configuration</code> for all feign clients. Can contain override <code>@Bean</code> definition
     * for the pieces that make up the client, for instance {@link feign.codec.Decoder}, {@link feign.codec.Encoder},
     * {@link feign.Contract}.
     *
