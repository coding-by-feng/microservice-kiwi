...
/**
 * YouTube Video Subtitles Translation Entity
 *
 * @author codingByFeng
 */
@Data
...
public class YtbVideoSubtitlesTranslation extends Model<YtbVideoSubtitlesTranslation> {

    private static final long serialVersionUID = 1L;

    public static final Integer TYPE_NOT_PROOFREAD = 1;
    public static final Integer TYPE_PROOFREAD = 2;
