...
import me.fengorz.kason.word.api.common.enumeration.ReviseBreakpointTypeEnum;
import me.fengorz.kason.word.api.entity.ParaphraseStarListDO;
import me.fengorz.kason.word.api.entity.ParaphraseStarRelDO;
import me.fengorz.kason.word.api.entity.column.WordParaphraseStarListColumn;
import me.fengorz.kason.word.api.vo.ParaphraseStarListVO;
import me.fengorz.kason.word.api.vo.star.ParaphraseStarItemVO;
import me.fengorz.kason.word.biz.mapper.ParaphraseStarListMapper;
...
public class ParaphraseStarListServiceImpl extends ServiceImpl<ParaphraseStarListMapper, ParaphraseStarListDO>
    ...
    public List<ParaphraseStarListVO> getCurrentUserList(Integer userId) {
        ...
        return KasonBeanUtils.convertFrom(mapper.selectList(queryWrapper), ParaphraseStarListVO.class);
    }
